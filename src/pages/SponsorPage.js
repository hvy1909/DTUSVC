...
function SponsorPagePage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "createDate",
      render: (joinDate) => (
        <span>{moment(joinDate).format("DD/MM/yyyy hh:mm:ss")}</span>
      ),
    },
    {
      title: "Người ủng hộ",
        ...
        <div>
          <Row>
            <Col span={4} xs={4} xl={4}>
              <img
                style={{ height: 25 }}
                src={GetFullPath(objAction.posterPath)}
              />
            </Col>
            <Col span={20} xs={20} xl={20}>
              <strong>{objAction.title}</strong>
            </Col>
          </Row>
        </div>
      );
  ...
  return (
    <div>
      ...
      <SponsorPayDlg
        x_bIsShowDlg={m_bIsShowDlg}
        x_objData={m_objQrData}
        x_evtOnCloseDlg={OnCancelDlg}
      />
      <div
      ...
      >
        ...
        <Card style={{ marginTop: 15 }}>
          ...
          <Form form={m_objSponsorForm} onFinish={CreateSponsorLink}>
            <Card style={{ marginTop: 15 }}>
              <Row>
                <Col
                  span={12}
                ...
                >
                  <Row>
                    ...
                    <Col span={18} xs={24} xl={18}>
                      ...
                      >
                        <Radio.Group
                          onChange={onChangeSponsorType}
                          value={m_lstSponsorValue}
                          disabled={m_nIsLoading}
                        >
                ...
                >
                  <Row>
                    ...
                    <Col span={21} xs={24} xl={21}>
                      <Form.Item name="fullName" style={{ textAlign: "left" }}>
                        <Input
                          placeholder="Nhập họ và tên"
                          maxLength={40}
                          disabled={m_lstSponsorType || m_nIsLoading}
                        />
                      </Form.Item>
                    </Col>
                  </Row>
